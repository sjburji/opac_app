class PlansController < ApplicationController
  def index
    branch = Branch.find(user_session['current_branch'].id)
  ...
  def plandetails
    ...
    @totalamount = @plan.totalAmount(@plan.security_deposit, @plan.registration_fee, @plan.reading_fee, effective_months, unit, @plan.subscription)
